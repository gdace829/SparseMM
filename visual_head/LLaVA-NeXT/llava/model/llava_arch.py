...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(self, input_ids, position_ids, attention_mask, past_key_values, labels, images, modalities, image_sizes=None):
        ...
        if vision_tower is None or images is None or input_ids.shape[1] == 1:
            return input_ids, position_ids, attention_mask, past_key_values, None, labels, return_image_feature
                ...
                for image_idx, image_feature in enumerate(image_features):
                    ...
                    if image_feature.shape[0] > 1:
                        ...
                        if "maxpool2x2" in mm_patch_merge_type:
                            ...
                            # import pdb; pdb.set_trace()
                            return_image_feature = image_feature.clone()
                                # flag_idxs = []
                                # origin_img_width, origin_img_height = image_sizes[image_idx]
                                ...
                                #     bbox = parse_data[1]
                                #     bbox_width = (bbox[0][0] / 1000 * origin_img_width, bbox[1][0] / 1000 * origin_img_width)
                                #     bbox_height = (bbox[0][1] / 1000 * origin_img_height, bbox[1][1] / 1000 * origin_img_height)
        ...
        if _position_ids is None:
            position_ids = None
        # import pdb; pdb.set_trace()
        return None, position_ids, attention_mask, past_key_values, new_input_embeds, new_labels, return_image_feature
